                    ...
                    <div class="container-fluid">
                        ...
                        <?php
                           ...
                           // echo $id_item;
                            ...
                            $result_itens = "SELECT * FROM tb_itens INNER JOIN tb_atas ON (tb_itens.id_item = '$id_item') and (tb_atas.id_ata = '$id_ata'); ";
                        ...
                        ?>
                        <form method="POST" action="proc_editar_itens.php">
                            <div class="form-group">
                                ...
                                <input type="text" name="ata" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="ata" value=" <?php echo $row_itens['ata']; ?>" disabled >

                                <br/>

                                <label for="exampleInputEmail1">UASG</label>
                                <input type="text" name="uasg" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row_itens['uasg']; ?>" disabled>
                                <br/>

                                <label for="exampleInputEmail1">ITEM</label>
                                <input type="text" name="item" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row_itens['item']; ?>">
                                <br/>

                                <label for="exampleInputEmail1">DESCRIÇÃO</label>
                                <textarea class="form-control" name="descricao" id="exampleFormControlTextarea1" rows="3"><?php echo $row_itens['descricao']; ?></textarea>
                                <br/>

                                <label for="exampleInputEmail1">UF</label>
                                <input type="text" name="uf" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row_itens['uf']; ?>">
                                <br/>

                                <label for="exampleInputEmail1">QTDE</label>
                                <input type="number" name="qtde" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row_itens['qtd']; ?>">
                                <br/>

                                <label for="exampleInputEmail1">PU EM R$</label>
                                <input type="text" name="pu" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row_itens['preco_unitario']; ?>">
                                <br/>

                                <label for="exampleInputEmail1">PT EM R$</label>
                                <input type="text" name="pt" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $row_itens['preco_total']; ?>">
