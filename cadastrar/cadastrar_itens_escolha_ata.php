                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                         ...
                         <?php
                            $result_ata = "SELECT * FROM tb_atas "; 
                            $resultado_ata = mysqli_query($conn, $result_ata);    
                         ?>

                        <form method="POST" action="cadastrar_itens.php">
                            <div class="form-group">
                                <h3 class="mt-5">Escolha a ATA</h3>
                                <div class="form-group">
                                <select class="form-control" id="exampleFormControlSelect1" name="ata_escolha">
                                     <?php while($row_ata = mysqli_fetch_assoc($resultado_ata)){ ?>
                                        <option  value="<?php echo $row_ata['ata']; ?>"> <?php echo$row_ata['ata']; ?></option>
                                    <?php } ?>
                                </select>
                                <br>
                               <!-- <label for="exampleInputEmail1">QUANTIDADE DE ITENS</label>
                                <input type="number" name="quant_itens" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">-->
                                </div>
                            </div>
