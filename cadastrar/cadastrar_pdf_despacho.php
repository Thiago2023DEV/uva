            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <form method="POST" action="proc_cadastrar_pdf_despacho.php" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                ?>
                                <h3 class="mt-5">Escolha o DESPACHO</h3>
                                <div class="form-group">
                                <select class="form-control" id="exampleFormControlSelect1" name="id_despacho">
                                     <?php while($row_despacho = mysqli_fetch_assoc($resultado_despacho)){ ?>
                                        <option  value="<?php echo $row_despacho['id_despacho']; ?>"> <?php echo$row_despacho['id_despacho']; ?></option>
                                    <?php } ?>
                                </select>
                                <br>
                                <div class="form-group">
