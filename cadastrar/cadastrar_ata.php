            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <form method="POST" action="proc_cadastrar_ata.php" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="exampleInputEmail1">ATA</label>
                                <input type="text" name="ata" class="form-control" id="ata" aria-describedby="emailHelp">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="vigencia" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">UASG</label>
                                <input type="text" name="uasg" class="form-control" id="exampleInputPassword1" >
                            </div>

                            <div class="form-group">
                                <label for="exampleInputPassword1">EMPRESA</label>
                                <input type="text" name="empresa" class="form-control" id="text" >
                                <script>
