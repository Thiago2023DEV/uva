                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="/projeto_atualizado/cadastrar/proc_cadastrar_despacho.php" method="POST">
                                    <?php  
                                        $irp = $_POST['irp'];
                                        $pregao = $_POST['pregao'];
                                        $orgao = $_POST['orgao'];
                                        ...
                                        $id_ata = $_POST['id_ata'];
                                         foreach ($id_ata as $e) {
                                            ...
                                            {
                                             //echo $e;
                                             $result_atas = "SELECT * FROM tb_atas WHERE id_ata = '$e'";
                                             $resultado_atas = mysqli_query($conn, $result_atas);


                                             $result_itens = "SELECT * FROM tb_itens WHERE id_ata = '$e'";
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        <thead>
                                            ...
                                            <?php while($row_atas = mysqli_fetch_assoc($resultado_atas)){ ?>
                                                <tr>
                                                    <th colspan="4"><?php echo "". $row_atas['ata']. ""; ?></th>    
                                                </tr>
                                            <?php }?>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><input type="checkbox"  name="id_item[]" value="<?php echo "". $row_usuario['id_item']. ""; ?>"></td>
                                                    <td><?php echo "". $row_usuario['item']. ""; ?></td>
                                                    <td colspan="1"><?php echo "". $row_usuario['descricao']. ""; ?></td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                ...
                                ?>
                                    ...
                                    <br>
                                    <input type="submit" class="btn btn-dark btn-block" value="Avançar">
                                    <br>
                                    </form>
                                </div>
                            </div>
