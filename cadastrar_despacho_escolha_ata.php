                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <?php
                             ...
                             $result_itens = "SELECT * FROM tb_atas WHERE id_ata IN (SELECT DISTINCT id_ata FROM tb_itens); ";
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form action="/projeto_atualizado/cadastrar/cadastrar_despacho.php" method="POST">
                                        ...
                                        <tfoot>
                                           <tr>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><input type="checkbox"  name="id_ata[]" value="<?php echo "". $row_usuario['id_ata']. ""; ?>"></td>
